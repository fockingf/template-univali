...
\begin{figure}[!htb]
  \centering
  % Título e fonte alinhados à margem esquerda DA FIGURA (não do texto), NBR 14724 5.8.
  \elementocomfonte[\caption{Legenda da figura (acima da figura, conforme NBR 14724).}\label{fig:exemplo}]%
    {\figuraplaceholder{0.6\textwidth}{4cm}{imagens/sua-figura.png}}%
