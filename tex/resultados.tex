...
\begin{figure}[!htb]
  \centering
  % Título e fonte alinhados à margem esquerda DO GRÁFICO (não do texto), NBR 14724 5.8.
  \elementocomfonte[\caption{Exemplo de gráfico de barras gerado com pgfplots.}\label{fig:grafico}]{%
  \begin{tikzpicture}
  \begin{axis}[
